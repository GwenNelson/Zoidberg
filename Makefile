...
INCLUDES=-I. -Inewlib/newlib/libc/include -Iefilibc/efi/inc -Iefilibc/efi/inc/protocol -Iefilibc/efi/inc/x86_64 -Ilibnet/src -Ipawn/source/amx/ -Ivm
...
boot.img: BOOTX64.EFI 
	...
	mcopy -i $@ userland/build/init ::/EFI/BOOT/sbin
